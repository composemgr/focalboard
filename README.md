...
Open-source project management and collaboration tool
...
- **focalboard**: focalboard/focalboard:latest

### Infrastructure Components

- **focalboard-db**: Postgres database
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/focalboard/main/docker-compose.yaml" -o compose.yml
```
